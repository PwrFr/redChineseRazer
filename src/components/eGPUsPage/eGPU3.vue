<template>
        <div class="usp" data-pnx="-1" id="available" style="background-image: url(/src/assets/products/2eGPUs/corex-comparison-bg.jpg); background-color: rgb(29, 29, 29); min-height: 900px;">
            <div style="max-height: 900px; text-align:center;">
                <div style="padding: 32px">
                    <h2 style="font-weight: 200; color:#44d62c;">AVAILABLE MODELS</h2>
                    <p style="color: white; font-size: 1.125em; font-weight: 300;">Razer Core X   |    Razer Core X Chroma™</p>
                    <ul data-pnx-f="icons" style="max-width: 700px; margin: 0px auto;">
                        <li>
                            <div style="margin: 30px">
                                <img alt="" src="/src/assets/products/2eGPUs/3.png" class="ng-star-inserted" style="max-width: 100%;">
                            </div>
                        </li>
                    </ul>
                    <div><br>
