...
export default {
  ...
  data() {
    return {
      ...
      bgComponent: "/src/assets/img/eGPUs/Chroma/1.jpg",
  ...
  methods: {
    firstSelecter() {
      ...
      this.imageAmount = "6";
      this.imageTab1 = "/src/assets/img/eGPUs/RazerCoreX-Black/s1.jpg";
      this.imageTab2 = "/src/assets/img/eGPUs/RazerCoreX-Black/s2.jpg";
      this.imageTab3 = "/src/assets/img/eGPUs/RazerCoreX-Black/s3.jpg";
      this.imageTab4 = "/src/assets/img/eGPUs/RazerCoreX-Black/s4.jpg";
      this.imageTab5 = "/src/assets/img/eGPUs/RazerCoreX-Black/s5.jpg";
      this.imageTab6 = "/src/assets/img/eGPUs/RazerCoreX-Black/s6.jpg";
      this.bgComponent = "/src/assets/img/eGPUs/RazerCoreX-Black/1.jpg";
      this.imageLocateSrc = "/src/assets/img/eGPUs/RazerCoreX-Black/";
    ...
    secondSelecter() {
      ...
      this.imageAmount = "6";
      this.imageTab1 = "/src/assets/img/eGPUs/RazerCoreX-Mercury/s1.jpg";
      this.imageTab2 = "/src/assets/img/eGPUs/RazerCoreX-Mercury/s2.jpg";
      this.imageTab3 = "/src/assets/img/eGPUs/RazerCoreX-Mercury/s3.jpg";
      this.imageTab4 = "/src/assets/img/eGPUs/RazerCoreX-Mercury/s4.jpg";
      this.imageTab5 = "/src/assets/img/eGPUs/RazerCoreX-Mercury/s5.jpg";
      this.imageTab6 = "/src/assets/img/eGPUs/RazerCoreX-Mercury/s6.jpg";
      this.bgComponent = "/src/assets/img/eGPUs/RazerCoreX-Mercury/1.jpg";
      this.imageLocateSrc = "/src/assets/img/eGPUs/RazerCoreX-Mercury/";
      this.modelBoxDisappear = "0";
      this.shippingDate = "Ships next business day";
      this.buyingStatus = "ADD TO CART";
      this.buyingAt = "Also Available At";
    ...
    thirdSelecter() {
      ...
      this.imageAmount = "5";
      this.imageTab1 = "/src/assets/img/eGPUs/Chroma/s1.jpg";
      this.imageTab2 = "/src/assets/img/eGPUs/Chroma/s2.jpg";
      this.imageTab3 = "/src/assets/img/eGPUs/Chroma/s3.jpg";
      this.imageTab4 = "/src/assets/img/eGPUs/Chroma/s4.jpg";
      this.imageTab5 = "/src/assets/img/eGPUs/Chroma/s5.jpg";
      (this.imageTab6 = null),
        (this.bgComponent = "/src/assets/img/eGPUs/Chroma/1.jpg");
      this.imageLocateSrc = "/src/assets/img/eGPUs/Chroma/";
      this.modelBoxDisappear = "0";
      this.shippingDate = "Ships next business day";
      this.buyingStatus = "ADD TO CART";
      this.buyingAt = "Also Available At";
